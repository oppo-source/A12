...
/*
#define TEN_BITS (((get_project() == 18073) || (get_project() == 18593) || (get_project() == 19011) || (get_project() == 19301)) ? 1 : 0)
#define ELEVEN_BITS ((((get_project() >= 18531) && (get_project() <= 18539)) \
				|| ((get_project() >= 18151) && (get_project() <= 18159))) ? 1 : 0)
*/
#define TEN_BITS  0
