...
#define IFR_PROT_STEP1_1_ACK_MASK        ((0x1 << 6) \
					  ...
					  |(0x1 << 21) \
					  |(0x1 << 29))
#define IFR_PROT_STEP1_2_MASK            ((0x1 << 8))
#define IFR_PROT_STEP1_2_ACK_MASK        ((0x1 << 8))
#define IFR_PROT_STEP1_3_MASK            ((0x1 << 12) \
					  |(0x1 << 13))
#define IFR_PROT_STEP1_3_ACK_MASK        ((0x1 << 12) \
					  |(0x1 << 13))
...
#define MP0_SPMC_PROT_STEP1_1_ACK_MASK   ((0x1 << 12) \
					  |(0x1 << 26))
#define IPE_PROT_STEP1_0_MASK            ((0x1 << 6))
#define IPE_PROT_STEP1_0_ACK_MASK        ((0x1 << 6))
#define IPE_PROT_STEP2_0_MASK            ((0x1 << 5))
#define IPE_PROT_STEP2_0_ACK_MASK        ((0x1 << 5))
...
#define IPE_PWR_STA_MASK                 (0x1 << 13)
...
int spm_mtcmos_ctrl_mfg1(int state)
{
	...
	if (state == STA_POWER_DOWN) {
		...
		while (((spm_read(PWR_STATUS) & MFG1_PWR_STA_MASK)
			!= MFG1_PWR_STA_MASK)
			|| ((spm_read(PWR_STATUS_2ND)
			& MFG1_PWR_STA_MASK) != MFG1_PWR_STA_MASK))
			ram_console_update();
		INCREASE_STEPS;
#endif
		/* TINFO="Set PWR_CLK_DIS = 0" */
...
#endif
		/* TINFO="Set bus protect - step2 : 0" */
		spm_write(SMI_COMMON_SMI_CLAMP_SET, IPE_PROT_STEP2_0_MASK);
#ifndef IGNORE_MTCMOS_CHECK
		while ((spm_read(SMI_COMMON_SMI_CLAMP)
...
#endif
		/* TINFO="Release bus protect - step2 : 0" */
		spm_write(SMI_COMMON_SMI_CLAMP_CLR, IPE_PROT_STEP2_0_MASK);
#ifndef IGNORE_MTCMOS_CHECK
#endif
		/* TINFO="Release bus protect - step1 : 0" */
...
int spm_mtcmos_ctrl_mfg3(int state)
{
	...
	if (state == STA_POWER_DOWN) {
		...
		while (((spm_read(PWR_STATUS) & MFG3_PWR_STA_MASK)
			!= MFG3_PWR_STA_MASK)
			|| ((spm_read(PWR_STATUS_2ND)
			& MFG3_PWR_STA_MASK) != MFG3_PWR_STA_MASK))
			ram_console_update();
		INCREASE_STEPS;
#endif
		/* TINFO="Set PWR_CLK_DIS = 0" */
...
int spm_mtcmos_ctrl_vpu_core2_dormant(int state)
{
	...
	DBG_ID = DBG_ID_VPU_CORE2_DORMANT;
	DBG_STA = state;
	DBG_STEP = 0;
	...
	if (state == STA_POWER_DOWN) {
		...
		INCREASE_STEPS;
#endif
		/* TINFO="VPU_CORE2_SRAM_CON[0]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 0));
		/* TINFO="VPU_CORE2_SRAM_CON[1]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 1));
		/* TINFO="Delay 1us" */
		udelay(1);
		/* TINFO="VPU_CORE2_SRAM_CON[4]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 4));
		/* TINFO="VPU_CORE2_SRAM_CON[5]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 5));
		/* TINFO="VPU_CORE2_SRAM_CON[6]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 6));
		/* TINFO="VPU_CORE2_SRAM_CON[7]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 7));
		/* TINFO="VPU_CORE2_SRAM_CON[8]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 8));
		/* TINFO="VPU_CORE2_SRAM_CON[9]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 9));
		/* TINFO="VPU_CORE2_SRAM_CON[10]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 10));
		/* TINFO="VPU_CORE2_SRAM_CON[11]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 11));
		/* TINFO="VPU_CORE2_SRAM_CON[12]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 12));
		/* TINFO="VPU_CORE2_SRAM_CON[13]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 13));
		/* TINFO="Set PWR_ISO = 1" */
		...
		spm_write(VPU_CORE2_PWR_CON,
			spm_read(VPU_CORE2_PWR_CON) | PWR_RST_B);
		/* TINFO="VPU_CORE2_SRAM_CON[4]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 4));
		/* TINFO="VPU_CORE2_SRAM_CON[5]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 5));
		/* TINFO="VPU_CORE2_SRAM_CON[6]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 6));
		/* TINFO="VPU_CORE2_SRAM_CON[7]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 7));
		/* TINFO="VPU_CORE2_SRAM_CON[8]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 8));
		/* TINFO="VPU_CORE2_SRAM_CON[9]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 9));
		/* TINFO="VPU_CORE2_SRAM_CON[10]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 10));
		/* TINFO="VPU_CORE2_SRAM_CON[11]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 11));
		/* TINFO="VPU_CORE2_SRAM_CON[12]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 12));
		/* TINFO="VPU_CORE2_SRAM_CON[13]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 13));
		/* TINFO="Delay 1us" */
		udelay(1);
		/* TINFO="VPU_CORE2_SRAM_CON[1]=1"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) | (0x1 << 1));
		/* TINFO="Delay 1us" */
		udelay(1);
		/* TINFO="VPU_CORE2_SRAM_CON[0]=0"*/
		spm_write(VPU_CORE2_SRAM_CON,
			spm_read(VPU_CORE2_SRAM_CON) & ~(0x1 << 0));
		/* TINFO="Release bus protect - step1 : 0" */
		spm_write(INFRA_TOPAXI_PROTECTEN_MCU_CLR,
