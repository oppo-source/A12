...
int fsm_ccism_init_done_handler(int md_id, int data)
{
#ifdef FEATURE_SCP_CCCI_SUPPORT
	ccci_scp_ipi_send(md_id, CCCI_OP_SHM_INIT_DONE, NULL);
#endif
	return 0;
}
...
int fsm_scp_init(struct ccci_fsm_scp *scp_ctl)
{
	...
	register_ccci_sys_call_back(scp_ctl->md_id, CCISM_SHM_INIT_DONE,
