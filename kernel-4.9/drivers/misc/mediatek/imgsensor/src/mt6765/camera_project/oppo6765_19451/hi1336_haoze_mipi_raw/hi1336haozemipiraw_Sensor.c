...
#include "hi1336haozemipiraw_Sensor.h"
...
#endif
#define ENABLE_HI1336_HAOZE_OTP 1
//#define LONG_EXPOSURE

#define PFX "hi1336_haoze_camera_sensor"
...
//PDAF
#define HI1336_HAOZE_ENABLE_PDAF
//#define e2prom 1

#define per_frame 1

extern bool read_hi1336_haoze_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size);
extern bool read_eeprom( kal_uint16 addr, BYTE * data, kal_uint32 size);

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336_HAOZE_SENSOR_ID,
...
#ifdef HI1336_HAOZE_ENABLE_PDAF
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336_haoze pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 24,
    .i4PitchX = 32,
    ...
    .iMirrorFlip = 0,
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336_haoze pdaf end */
};
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4208_2368 =
/* litao@Camera.Driver, 2019/01/16, modify for hi1336_haoze pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 0,
    .i4PitchX = 32,
    ...
    /* 0:IMAGE_NORMAL,1:IMAGE_H_MIRROR,2:IMAGE_V_MIRROR,3:IMAGE_HV_MIRROR */
    .iMirrorFlip = 0,
/* litao@Camera.Driver, 2019/01/16, modify for hi1336_haoze pdaf end */
};
...
#ifdef ENABLE_HI1336_HAOZE_OTP
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= HI1336_HAOZE_SENSOR_ID,
	.deviceID = 1,
	.dataLength = 0x0CDF,
...
static struct stCAM_CAL_CHECKSUM_STRUCT hi1336haozeChecksum[MAX_ITEM + 1] =
{
	...
	{PDAF_ITEM,0x0780,0x0780,0x0CDC,0x0CDD,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x0CDD,0x0CDE,0x55},
...
static kal_uint16 hi1336_haoze_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_hi1336_haoze[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
static void sensor_init(void)
{
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_init_hi1336_haoze,
		sizeof(addr_data_pair_init_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe1b0,
	0x1118, 0x0004,
...
static void preview_setting(void)
{
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336_haoze,
		sizeof(addr_data_pair_preview_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_30fps_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static kal_uint16 addr_data_pair_capture_15fps_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps > 150) {
		hi1336_haoze_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_hi1336_haoze,
			sizeof(addr_data_pair_capture_30fps_hi1336_haoze) /
			sizeof(kal_uint16));
	} else {
		hi1336_haoze_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_hi1336_haoze,
			sizeof(addr_data_pair_capture_15fps_hi1336_haoze) /
			sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_video_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x017e,
...
static void video_setting(void)
{
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_video_hi1336_haoze,
		sizeof(addr_data_pair_video_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_hi1336_haoze[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe4b0,
	0x1118, 0x0072,
...
static void hs_video_setting(void)
{
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336_haoze,
		sizeof(addr_data_pair_hs_video_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
static void slim_video_setting(void)
{
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336_haoze,
		sizeof(addr_data_pair_slim_video_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_custom1_hi1336_haoze[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0000,
...
static void custom1_setting(void){
	...
	hi1336_haoze_table_write_cmos_sensor(
		addr_data_pair_custom1_hi1336_haoze,
		sizeof(addr_data_pair_custom1_hi1336_haoze) /
		sizeof(kal_uint16));
#else
...
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_HAOZE_OTP
		size = imgSensorReadEepromData(&sensor_eeprom_data, hi1336haozeChecksum);
		...
		do {
		    *sensor_id = return_sensor_id();
		    if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("vcmid:%d", sensor_eeprom_data.dataBuffer[4]);
				if(0x02 != sensor_eeprom_data.dataBuffer[4]){
				    *sensor_id = 0xFFFFFFFF;
				    return ERROR_SENSOR_CONNECT_FAIL;
				}
				#ifdef HARDWARE_INFO
				hardwareinfo_set_prop(HARDWARE_BACK_CAM, "HI1336_HAOZE");
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "tongxingda-haoze");
				#endif
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_HAOZE_OTP
...
UINT32 HI1336_HAOZE_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
