...
#ifdef __ENABLE_VIDEO_CUSTOM_PDAF__ //litao@Camera.Driver, 2019/01/16, modify for hi1336
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4208_2368 =
/* litao@Camera.Driver, 2019/01/16, modify for hi1336 pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 0,
    .i4PitchX = 32,
    ...
    /* 0:IMAGE_NORMAL,1:IMAGE_H_MIRROR,2:IMAGE_V_MIRROR,3:IMAGE_HV_MIRROR */
    .iMirrorFlip = 0,
/* litao@Camera.Driver, 2019/01/16, modify for hi1336 pdaf end */
};
...
static struct stCAM_CAL_CHECKSUM_STRUCT hi1336Checksum[7] =
{
...
static void video_setting(void)
{
	...
	write_cmos_sensor(0x1012, 0x00f0);
