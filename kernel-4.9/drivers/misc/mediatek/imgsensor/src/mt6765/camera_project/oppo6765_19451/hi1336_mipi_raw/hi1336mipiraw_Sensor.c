...
#ifdef HI1336_ENABLE_PDAF
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336 pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 24,
    .i4PitchX = 32,
    ...
    .iMirrorFlip = 0,
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336 pdaf end */
};
...
static struct stCAM_CAL_CHECKSUM_STRUCT hi1336Checksum[MAX_ITEM + 1] =
{
...
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_OTP
		size = imgSensorReadEepromData(&sensor_eeprom_data, hi1336Checksum);
		...
		do {
		    *sensor_id = return_sensor_id();
		    if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(0x01 != sensor_eeprom_data.dataBuffer[4]){
				    *sensor_id = 0xFFFFFFFF;
				    return ERROR_SENSOR_CONNECT_FAIL;
				}

				#ifdef HARDWARE_INFO
				hardwareinfo_set_prop(HARDWARE_BACK_CAM, "HI1336");
