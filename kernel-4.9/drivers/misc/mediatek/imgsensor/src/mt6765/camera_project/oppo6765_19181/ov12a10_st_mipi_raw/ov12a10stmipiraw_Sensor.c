 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV12a10STEB_03B
 *---------------------------------------------------------------------------
 * Upper this line, this part is controlled by CC/CQ. DO NOT MODIFY!!
 *============================================================================
 ****************************************************************************/

#define PFX "ov12a10_st_camera_sensor"
...
#include "ov12a10stmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV12A10_ST_SENSOR_ID,
...
//normal-video
	{ 4112, 3088,    0,    0, 4112, 3088, 4112, 3088,
	8,    392, 4096, 2304,    0,    0, 4096, 2304},
//hs-video
	{ 4112, 3088,   0,   0, 4112,   3088,   1028,    772,  194, 146,   640,  480,  0,   0,    640,  480},//hs-video
//slim-video
	{ 4112, 3088,  0, 0, 4112,   3088,   2056,  1544,
	4, 4,  2048,  1536,  0,   0,   2048,  1536},
//custom1
	...
	4,    4, 2048, 1536,    0,    0, 2048, 1536},
//custom2
	{ 4112, 3088,    0,    0, 4112, 3088, 4112, 2560,424,   56, 3264, 2448,    0,    0, 3264, 2448},
};
...
static kal_uint16 ov12a10_st_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov12a10_st[] = {
	0x0103, 0x01,
	0x0302, 0x49,
	0x0303, 0x00,
	0x0304, 0x00,
...
static void sensor_init(void) //check out
{
	...
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_init_ov12a10_st,
		sizeof(addr_data_pair_init_ov12a10_st) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x3631, 0x30);//0x00->0x30
	...
	write_cmos_sensor(0x380e, 0x0d);//d12->D37=3383
	write_cmos_sensor(0x380f, 0x37);//12
	...
	write_cmos_sensor(0x484b, 0x03);//01->03 T3
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov12a10_st[] = {
	0x3642, 0x10,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void preview_setting(void)//jack yan check
{
...
#if MULTI_WRITE
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_preview_ov12a10_st,
		sizeof(addr_data_pair_preview_ov12a10_st) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x380b, 0x00);
	write_cmos_sensor(0x380e, 0x0d);//d12 = 3346->d37=3383
	write_cmos_sensor(0x380f, 0x37);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov12a10_st[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
	...
	0x3813, 0x0a//0x08->0x0a
};

kal_uint16 addr_data_pair_capture_24fps_ov12a10_st[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_pair_capture_30fps_ov12a10_st[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_normal_video_30fps_ov12a10_st[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void capture_setting(kal_uint16 currefps)//jack yan check
{
	...
	if (currefps == 150) {
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov12a10_st,
		sizeof(addr_data_pair_capture_15fps_ov12a10_st) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_ov12a10_st,
		sizeof(addr_data_pair_capture_24fps_ov12a10_st) /
		sizeof(kal_uint16));
	} else {
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov12a10_st,
		sizeof(addr_data_pair_capture_30fps_ov12a10_st) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
{
	LOG_INF("normal_video_setting RES_4096*2304_30fps\n");
#if MULTI_WRITE
	ov12a10_st_table_write_cmos_sensor(
		addr_data_normal_video_30fps_ov12a10_st,
		sizeof(addr_data_normal_video_30fps_ov12a10_st) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3642, 0x12);
	write_cmos_sensor(0x3666, 0x08);
	...
	write_cmos_sensor(0x380a, 0x0c);
	write_cmos_sensor(0x380b, 0x00);
	write_cmos_sensor(0x380e, 0x0d);//3383
	write_cmos_sensor(0x380f, 0x37);
	write_cmos_sensor(0x3810, 0x00);
	write_cmos_sensor(0x3811, 0x0a);
	write_cmos_sensor(0x3813, 0x08);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov12a10_st[] = {
	0x3642, 0x08,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void hs_video_setting(void)
{
...
#if MULTI_WRITE
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov12a10_st,
		sizeof(addr_data_pair_hs_video_ov12a10_st) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x3810, 0x00);
	write_cmos_sensor(0x3811, 0xc2);
	write_cmos_sensor(0x3813, 0x92);
	write_cmos_sensor(0x3814, 0x07);
	write_cmos_sensor(0x3816, 0x07);
	write_cmos_sensor(0x3820, 0xb4);
...
static void custom1_setting(void)
{
	...
	//write_cmos_sensor(0x380f, 0x12);
	write_cmos_sensor(0x380e, 0x10);//d12->1056
	write_cmos_sensor(0x380f, 0x85);
	write_cmos_sensor(0x3810, 0x00);
	write_cmos_sensor(0x3811, 0x04);
	write_cmos_sensor(0x3813, 0x04);
	write_cmos_sensor(0x3814, 0x03);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_24fps_ov12a10_st[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void custom2_setting(void)//jack yan check
{
...
#if MULTI_WRITE
	ov12a10_st_table_write_cmos_sensor(
		addr_data_pair_custom2_24fps_ov12a10_st,
		sizeof(addr_data_pair_custom2_24fps_ov12a10_st) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3642, 0x12);
	write_cmos_sensor(0x3666, 0x08);
	...
	//write_cmos_sensor(0x380e, 0x0d);
	//write_cmos_sensor(0x380f, 0x12);
	write_cmos_sensor(0x380e, 0x10);//d12->1085=4229
	write_cmos_sensor(0x380f, 0x85);
	write_cmos_sensor(0x3810, 0x00);
	write_cmos_sensor(0x3811, 0x0a);
	write_cmos_sensor(0x3813, 0x08);
...
static kal_uint16 read_otp(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(0), (char)(addr & 0xFF) };
...
static kal_uint32 return_otp(kal_uint32 addr)
{
	return (read_otp(addr));
}
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		switch (*feature_data) {
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			imgsensor_pd_info.i4BlockNumX = 128;
			imgsensor_pd_info.i4BlockNumY = 96;
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info,
				sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			imgsensor_pd_info.i4BlockNumX = 128;
			imgsensor_pd_info.i4BlockNumY = 72;
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info,
				sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
...
UINT32 OV12A10_ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
	{
