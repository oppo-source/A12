...
#endif
#define ENABLE_HI1336_HOLITECH_OTP
//#define LONG_EXPOSURE

#define PFX "hi1336_holitech_camera_sensor"
...
//PDAF
#define HI1336_HOLITECH_ENABLE_PDAF
//#define e2prom 1

#define per_frame 1

extern bool read_hi1336_holitech_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size);
extern bool read_eeprom( kal_uint16 addr, BYTE * data, kal_uint32 size);

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336_HOLITECH_SENSOR_ID,
...
#ifdef HI1336_HOLITECH_ENABLE_PDAF
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336_holitech pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 24,
    .i4PitchX = 32,
    ...
    .iMirrorFlip = 0,
/* Hanyue.Shao@Camera.Driver, 2018/11/29, modify for hi1336_holitech pdaf end */
};
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4208_2368 =
/* huangmiao@Camera.Driver, 2020/02/25, modify for hi1336 video pdaf */
{
    .i4OffsetX = 56,
    .i4OffsetY = 0,
    .i4PitchX = 32,
...
/* huangmiao@Camera.Driver, 2020/02/25, modify for hi1336 pdaf start */
{
    .i4OffsetX = 56,
    .i4OffsetY = 24,
    .i4PitchX = 32,
...
#endif
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_HOLITECH_OTP
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= HI1336_HOLITECH_SENSOR_ID,
	.deviceID = 1,
	.dataLength = 0x0CD8,
	.sensorVendorid = 0x42000000,
	.vendorByte = 1,
	.dataBuffer = NULL,
};

static struct stCAM_CAL_CHECKSUM_STRUCT hi1336holitechChecksum[MAX_ITEM + 1] =
{
	{MODULE_ITEM,0x0000,0x0000,0x0007,0x0008,0x55},
	{AWB_ITEM,0x0009,0x0009,0x0019,0x001A,0x55},
	{AF_ITEM,0x001B,0x001B,0x001F,0x0020,0x55},
	{LSC_ITEM,0x0021,0x0021,0x076D,0x076E,0x55},
	{PDAF_ITEM,0x076F,0x076F,0x0CD5,0x0CD6,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x0CD6,0x0CD7,0x55},
...
static kal_uint16 hi1336_holitech_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_hi1336_holitech[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
static void sensor_init(void)
{
	...
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_init_hi1336_holitech,
		sizeof(addr_data_pair_init_hi1336_holitech) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x1060, 0x340f);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe1b0,
	0x1118, 0x0004,
...
static void preview_setting(void)
{
	...
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336_holitech,
		sizeof(addr_data_pair_preview_hi1336_holitech) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x023a, 0x1122);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_30fps_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static kal_uint16 addr_data_pair_capture_15fps_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps > 150) {
		hi1336_holitech_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_hi1336_holitech,
			sizeof(addr_data_pair_capture_30fps_hi1336_holitech) /
			sizeof(kal_uint16));
	} else {
		hi1336_holitech_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_hi1336_holitech,
			sizeof(addr_data_pair_capture_15fps_hi1336_holitech) /
			sizeof(kal_uint16));
	}
#else
	...
	if( currefps > 150) {
		...
		write_cmos_sensor(0x0238, 0x1111);
		write_cmos_sensor(0x0246, 0x0020);
		write_cmos_sensor(0x020a, 0x1a00); //coarse integ time
		write_cmos_sensor(0x021c, 0x0008); //coarse integ time short for iHDR
		write_cmos_sensor(0x0206, 0x05dd); //line length pck
		write_cmos_sensor(0x020e, 0x1a04); //frame length lines
		write_cmos_sensor(0x0b12, 0x1070); //x output size
		write_cmos_sensor(0x0b14, 0x0c30); //y output size
		write_cmos_sensor(0x0204, 0x0000);
		write_cmos_sensor(0x041c, 0x0048);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_video_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x017e,
...
static void video_setting(void)
{
	...
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_video_hi1336_holitech,
		sizeof(addr_data_pair_video_hi1336_holitech) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x0730, 0x770f);
	write_cmos_sensor(0x0732, 0xe0b0);
	write_cmos_sensor(0x1118, 0x017e);
	write_cmos_sensor(0x1200, 0x0d1f);
	write_cmos_sensor(0x1204, 0x1c01);
	write_cmos_sensor(0x1240, 0x0100);
	write_cmos_sensor(0x0b20, 0x8100);
	...
	write_cmos_sensor(0x0222, 0x0c80);
	write_cmos_sensor(0x022c, 0x0c89);
	write_cmos_sensor(0x0224, 0x01a4);
	write_cmos_sensor(0x022e, 0x0ae7);
	write_cmos_sensor(0x0f04, 0x0008);
	write_cmos_sensor(0x0f06, 0x0000);
	write_cmos_sensor(0x023a, 0x1111);
	write_cmos_sensor(0x0234, 0x1111);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_hi1336_holitech[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe4b0,
	0x1118, 0x0072,
...
{
#if MULTI_WRITE
	LOG_INF("hs_video_setting multi write\n");
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336_holitech,
		sizeof(addr_data_pair_hs_video_hi1336_holitech) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
static void slim_video_setting(void)
{
	...
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336_holitech,
		sizeof(addr_data_pair_slim_video_hi1336_holitech) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_custom1_hi1336_holitech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0000,
...
static void custom1_setting(void){
	...
	hi1336_holitech_table_write_cmos_sensor(
		addr_data_pair_custom1_hi1336_holitech,
		sizeof(addr_data_pair_custom1_hi1336_holitech) /
		sizeof(kal_uint16));
#else
...
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_HOLITECH_OTP
		size = imgSensorReadEepromData(&sensor_eeprom_data, hi1336holitechChecksum);
		...
		do {
		    *sensor_id = return_sensor_id();
		    if (*sensor_id == imgsensor_info.sensor_id) {
				/* Tao.Li@Camera.Driver, 2019/12/25, add for [Cola hardwareinfo bringup] */
				#ifdef HARDWARE_INFO
				hardwareinfo_set_prop(HARDWARE_BACK_CAM, "HI1336_HOLITECH");
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "holitech");
				#endif
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_HOLITECH_OTP
...
UINT32 HI1336_HOLITECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
