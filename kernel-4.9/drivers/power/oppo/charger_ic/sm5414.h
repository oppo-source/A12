...
extern int sm5414_otg_enable(unsigned int enable);
extern int sm5414_chg_enable_gpio(unsigned int enable);
extern void sm5414_dump_register(void);
extern unsigned int sm5414_get_topoff_status(unsigned char *val);
...
extern int sm5414_read_byte(unsigned char cmd, unsigned char *returnData);
#endif // _sm5414_SW_H_
