...
void fgauge_get_profile_id(void)
{
	int id_volt = 0;
#ifndef ODM_HQ_EDIT
/*Hanxing.Duan@ODM.HQ.BSP.CHG.Basic 2019.1.12 remove for old read battery id*/
	int id = 0;
#endif /*ODM_HQ_EDIT*/
	int ret = 0;
...
#ifndef ODM_HQ_EDIT
/*Hanxing.Duan@ODM.HQ.BSP.CHG.Basic 2018.12.20 remove MTK check battery id*/
...
void bmd_ctrl_cmd_from_user(void *nl_data, struct fgd_nl_msg_t *ret_msg)
{
	...
	case FG_DAEMON_CMD_SET_KERNEL_UISOC:
	{
		...
		int old_uisoc;
#ifdef ODM_HQ_EDIT
/*Hanxing.Duan@ODM.HQ.BSP.CHG.Basic 2019.02.25 add get monitic rtc soc*/
		int rtc_soc;
...
#ifdef ODM_HQ_EDIT
/*Hanxing.Duan@ODM.HQ.BSP.CHG.Basic 2019.02.25 delet for mtk init soc*/
		get_monotonic_boottime(&now_time);
